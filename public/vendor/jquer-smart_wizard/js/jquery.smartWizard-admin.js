...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            // var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text('Next Step').addClass('btn sw-btn-next').attr('id', 'donor_q_next').css({'backgroundColor':'red','color':'white','borderRadius':'5px'}).attr('type', 'button') : null;
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text('Next Step').addClass('btn sw-btn-next').attr('id', 'donor_q_next').css({
                ...
                'padding': 0,
                'transform': 'scale(0,0)'
            }).attr('type', 'button') : null;
            var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text(this.options.lang.previous).addClass('btn btn-secondary sw-btn-prev bttn').attr('type', 'button') : null;
            // var btnGroup = $('<div></div>').addClass('btn-group mx-auto sw-btn-group bttn').attr('role', 'group').append( btnNext);
            var btnGroup = $('<div>').addClass('btn-group mx-auto sw-btn-group bttn').css('opacity', 1).attr('role', 'group').append(btnPrevious);

//            ------------------
//            $(btnNext).click(function(){
//            var text=$(".sw-theme-dots > ul.step-anchor > li.active > a > i").text();
//            console.log(text);
//            
//        });
...
//            ---------------------
            ...
            if (this.options.toolbarSettings.toolbarExtraButtons && this.options.toolbarSettings.toolbarExtraButtons.length > 0) {
                btnGroupExtra = $('<div></div>').addClass('btn-group sw-btn-group-extra bttn').attr('role', 'group');
...
//            if(count==0){
//                console.log('working');
//                $('.sw-btn-next', this.main).attr('type','submit');
//                $('.sw-btn-next', this.main).attr('id','submit1');
...
//                        $("#congrats").modal(open);
                ...
                count++;
//                var text=$(".sw-theme-dots > ul.step-anchor > li.active > a > i").html();
//                $("#exampleModal .modal-header .modal-title").html(text);
