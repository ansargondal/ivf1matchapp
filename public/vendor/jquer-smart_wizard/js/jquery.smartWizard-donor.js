...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        _setToolbar: function () {
            ...
            var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text('Next Step').addClass('btn sw-btn-next').attr('id', 's_f1_next').css({
                'backgroundColor': '#bd2440',
                'color': 'white',
                'borderRadius': '5px'
