...
//region (STEP 7) Medical History Step 2 Information Validation
    ...
    $body.on("keyup", "#i_medical_prob_1", function () {

        if ($(this).val() !== "") {

            var inputs = $(this).closest('tr').find('input.form-control');
            ...
            // $('#i_age_onset_1').addClass('required');
            // $('#i_medical_comment_1').addClass('required');
        } else {
...
function attachCustomError() {
    ...
    inputs.each(function () {
        if ($(this).parents('.from-group').find('.required-label').length) {
        } else {
            $(this).after('<label id="i_age_onset_1-error" class="error required-label" for="i_age_onset_1">*required</label>');
        }
    });
}
